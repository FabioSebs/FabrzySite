  ...
  return (
    <div className="flex md:gap-10 gap-5 md:scale-150 scale-110 top-3 relative">
      <div
        ...
        className="w-[50px] h-[50px] bg-gray-400 rounded-full inline-block relative flex justify-center items-center hover:cursor-pointer duration-300 text-white hover:text-blue-600 shadow-xl"
      >
        <EmailIcon />
      </div>
      <div
